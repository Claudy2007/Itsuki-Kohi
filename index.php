...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        $_SESSION['usuario'] = $usuario;header("Location: Inicio.html");
        exit();
    } else {
...
<head>
    ...
    <title>Login</title>
    <style>
        /* Incluye aquí el CSS revisado */
        body {
            background-color: rgba(219, 178, 233, 1);
            height: auto;
            width: auto;
...
<body>
    <nav>
        ...
        <li><a href="bebidas.html">Menú</a></li>
        <li><a href="contactanos.html">Contactanos</a></li>
        <li><a class="active" href="index.php">Iniciar Sesión</a></li>
        </ul>
    </nav>
    <div>
        <img class="fondoizq" src="fondogatos.png"/> 
    </div>
    <div class="login">
        <h1>LOG-IN</h1>
        <form method="post" action="">
            ...
            <p>Yo soy <a href="administrador.php">Administrador</a></p>
        </form>
        <img class="imgperfil" src="https://cdn-icons-png.flaticon.com/512/6073/6073873.png" />
    </div>
    <footer class="footer">
        <div class="container">
            <div class="row">
