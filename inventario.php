...
if (
    isset($_POST['Producto']) && strlen($_POST['Producto']) >= 1 &&
    isset($_POST['CantidadProd_Inv']) && strlen($_POST['CantidadProd_Inv']) >= 1 &&
    isset($_POST['Productos_Inv']) && strlen($_POST['Productos_Inv']) >= 1

) {
    $prod = trim($_POST['Producto']);
    $cantidad = trim($_POST['CantidadProd_Inv']);
    $prod_Inv = trim($_POST['Productos_Inv']);
    
    $consulta = "INSERT INTO inventario(Produtos,CantidadProd_Inv, Productos_Inv) VALUES ('$prod', '$cantidad', '$prod_Inv')";
...
<head>
  ...
  <style>
    ...
    .registro {
      ...
      padding: 20px;
      margin: 180px auto 20px; /* Añadir un margen superior para separar del nav */
      width: 450px;
      height: 520px;
      border-radius: 56px;
    ...
    <section class="registro">
      ...
      <form action="inventario.php" method="post">
        ...
        <input
          ...
          name="Productos_Inv"
          id="Productos_Inv"
          placeholder="Productos Frescos o comgelados"
        />
        <?php echo $mensaje; ?>
        <input class="botons" type="submit" value="Registrar" />
        <p>Ver <a href="invCRUD.php">Inventario</a></p> 
      </form>
    </section>
